...
In result, and since it was stated in the original README.txt (on the data set coming from the zip file) that "features are normalized and bounded within [-1,1]", these boundaries remained intact.
